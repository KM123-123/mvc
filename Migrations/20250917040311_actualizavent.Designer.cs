...
namespace mvc.Migrations
{
    ...
    [Migration("20250917040311_actualizavent")]
    partial class actualizavent
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("mvc.Models.Proveedores", b =>
                {
                    b.Property<int>("ProveedorID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("mvc.Models.Ubicaciones", b =>
                {
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("mvc.Models.Usuario", null)
                        .WithMany()
            ...
            modelBuilder.Entity("mvc.Models.Productos", b =>
                {
                    ...
                    b.HasOne("mvc.Models.Proveedores", "Proveedor")
                        .WithMany()
            ...
            modelBuilder.Entity("mvc.Models.Ventas", b =>
                {
                    b.HasOne("mvc.Models.Clientes", "Clientes")
                        .WithMany()
                        .HasForeignKey("ClientesClienteID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("mvc.Models.Productos", "Productos")
                        .WithMany()
